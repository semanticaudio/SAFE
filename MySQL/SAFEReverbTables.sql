CREATE TABLE SAFEReverbUserData (
...
numInputs int, 
numOutputs int,
Param_DampingFrequency double,
Param_Density double,
Param_BandwidthFrequency double,
Param_Decay double,
Param_PreDelay double,
Param_Size double,
Param_Gain double,
Param_Mix double,
Param_EarlyMix double,
...
CREATE TABLE SAFEReverbAudioFeatureData (
...
MFCC_11 double,
MFCC_12 double,
FOREIGN KEY (ID) REFERENCES SAFEReverbUserData (ID),
