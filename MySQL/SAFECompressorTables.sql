CREATE TABLE SAFECompressorUserData (
...
numInputs int, 
numOutputs int,
Param_Threshold double,
Param_Ratio double,
Param_Knee double,
Param_AttackTime double,
Param_ReleaseTime double,
Param_MakeUpGain double,
...
CREATE TABLE SAFECompressorAudioFeatureData (
...
MFCC_11 double,
MFCC_12 double,
FOREIGN KEY (ID) REFERENCES SAFECompressorUserData (ID),
